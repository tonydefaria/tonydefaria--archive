      ...
      <div className="hero top">
        ...
        <div className="hero-box half">
          <div className="hero-row">
            ...
            <hr className="separator-s" />
            <a aria-label="Menu Trigger" href="#" rel="nofollow" onClick={handleToggle} className="button-l button-black text-transform-uppercase font-weight-900">Open Gallery</a>
          </div>
        </div>
      </div>
